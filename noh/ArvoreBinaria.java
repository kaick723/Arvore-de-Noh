...
public class ArvoreBinaria {
	...
	public void setRaiz(Nohh raiz) {
		this.raiz = raiz;
	}
	//Inserir
	public void inserir(Nohh node, int valor) {
		if(raiz == null) {
			raiz = new Nohh(valor);
		}else {
			//Verifica se o valor a ser inserido é menor que o nodo corrente da Arvore, se sim vai para subarvore esquerda
			if(valor < node.getValor()) {
				...
				if (node.getNohEsq() != null) {
					...
					node.setNohEsq(new Nohh(valor));
				}
				//Verifica se o valor a ser inserido é maior que o nodo corrente da Arvore, se sim vai para subarvore direita
				...
				if (node.getNohDir() != null) {
					...
					node.setNohDir(new Nohh(valor));
				}			
			}
		}
	}
	//Remover
	public Nohh remover(Nohh node, int valor) {
		if (node == null) {
	...
	//Encontra Mínimo
	public Nohh encontraMinimo(Nohh node) {
		if (node != null) {
	...
	//Remove Mínimo
	public Nohh removeMinimo(Nohh node) {
		if (node == null) {
	...
	//Imprime
	public void imprime(Nohh inicial, int vezes) {
		if(inicial != null) {
			Nohh aux = inicial;
			//
